...
class AboutScreen extends StatelessWidget {
  ...
  void _onCallPressed() async {
     const phoneNumber = '+8801717219723';
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              SizedBox(height: 10),
              Text('This APP is developed as a flutter learning by:', style: TextStyle(
                color: Colors.white,
              ...
              CircleAvatar(
                radius: 60,
                backgroundImage: AssetImage('assets/images/PP_IMAGE_SM.jpeg'),
              ),
              Text(
                'Moloy Adhikary',
                style: TextStyle(
